...
<!-- This is the only page with an image not sourced from Powerpoint. The source is provided next to the image. -->
<!-- The background common to all pages is from Powerpoint however. -->
<!DOCTYPE html>
<html lang="en">

<head>
    <title>Artist - About</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container">
        ...
        <div class="side">
            ...
            <!-- IMAGE SOURCED FROM https://combineoverwiki.net/wiki/File:Bendy.svg -->
            <img src="images/defaultperson.png" alt="Artist portrait" class="portrait">
        </div>
